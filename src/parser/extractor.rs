...
impl Extraction {
    ...
    pub fn new() -> Extraction {
        Extraction::populate(None, None, None, None, None)
    }
...
// extract refs sources configs and vars from the typed ast.
...
fn extract_from(ast: ExprT) -> Extraction {
    match ast {
        ...
        ExprT::RefT(x, y) => Extraction::populate(Some(vec![(x, y)]), None, None, None, None),
